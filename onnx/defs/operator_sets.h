...
class ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 10, TestOp);
...
class ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 11, TCS);
...
class ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 11, HardSwish);
...
class OpSet_Onnx_ver11 {
 public:
  static void ForEachSchema(std::function<void(OpSchema&&)> fn) {
    ...
    fn(GetOpSchema<ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 11, HardSwish)>());
  }
};
...
class ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 13, TCS_EdgeAI);
...
class OpSet_Onnx_ver13 {
 public:
  static void ForEachSchema(std::function<void(OpSchema&&)> fn) {
    ...
    fn(GetOpSchema<ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 13, TCS_EdgeAI)>());
  }
};
